...
for file in "ast.c ast.h hash.c hash.h main.c Makefile scanner.l syntax.y symbols.h util.c util.h semantic.c semantic.h tac.c tac.h queue.c queue.h translate.c translate.h"
do
    cp $file tmp/;
done;
cd tmp;
